...
for exps = 1:experiments
    ...
    while diff>epsilon && i<max_iterations
        ...
        %Projection step
        [U1rec,U2rec,U3rec,Drec,What] = sparse_hosvd_v2(tensor(reshape(wr,[n1,n2,n3])),s1new,s2new,s3new,r1,r2,r3);
...
save('adhd_tpgd_kki.mat','r','mu','epsilon','wr_tensor','max_iterations','experiments','s1new',...
's2new','s3new')
